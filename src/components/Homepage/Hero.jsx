            ...
            <div className='h-full bg-[#F2F0F1] w-full flex justify-center items-center'>
                <div className='grid grid-cols-1 lg:grid-cols-2 h-full w-full'>
                    ...
                    <div className='p-8 flex flex-col  justify-center'>
                        ...
                        <div>
                            <button className='bg-black text-white px-14 py-3 rounded-4xl  hover:transform hover:scale-102 duration-200 cursor-pointer'>Shop Now</button>
                        </div>

                        <div className='flex lg:justify-between mt-6 lg:mt-10  justify-center space-y-1.5 '>
                            <div className='flex flex-col'>
                                <span className='text-2xl lg:text-5xl  font-bold tracking-wide'>2000+</span>
                                <span className='text-gray-500 text-sm'>International Brands</span>
                            </div>

                            <div className='flex flex-col border-gray-500 lg:border-l-2 pl-6 '>

                                <span className='text-2xl lg:text-5xl font-bold tracking-wide'>5000+</span>
                                <span className='text-gray-500 text-sm'>High Quality Products</span>

                            </div>

                            <div className='flex flex-col border-gray-500 lg:border-l-2 pl-6 '>

                                <span className='text-2xl lg:text-5xl font-bold tracking-wide'>80000+</span>
